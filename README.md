...
En esta primera entrega se ha desarrollado el **sistema de gestión de personajes**. El programa permite:

1.  **Crear Héroe:** - Validación de nombre único.
...
5.  **Mostrar datos:** Tabla visual con todos los personajes activos.
